...
class Fooditems:
    ...
    def maincourse():
        ...
        Constants.main_course = Frame(bg = "pink")
        Constants.main_course.place(x = 0, y = 0, width = 400, height = 500)
    

        sub_heading_1 = Label(Constants.main_course, text = "Items", font = "times 15 bold")
        sub_heading_1.place(x = 10, y = 70)

        sub_heading_2 = Label(Constants.main_course, text = "Price", font = "times 15 bold")
        sub_heading_2.place(x = 180, y = 70)

        sub_heading_3 = Label(Constants.main_course, text = "Add Cart", font = "times 15 bold")
        sub_heading_3.place(x = 300, y = 70)

        back_button = Button(Constants.main_course, text = "<< Back", font = ("rockwell", 11),foreground = 'blue', command = menu.Menu.food)
        back_button.place(x = 10, y = 10)

        home_button = Button(Constants.main_course, text = "Home", font = ("rockwell", 13),foreground = 'red', command=homepage.Homepage.home)
        home_button.place(x = 10, y = 450)

        payment_button = Button(Constants.main_course, text = "Payment", font = ("rockwell", 15),foreground = 'red',command=(lambda :billing.Billing.calculateMaincourse (add_cart_1.get(), add_cart_2.get(),add_cart_3.get(),add_cart_4.get(),add_cart_5.get())))
        payment_button.place(x = 140, y = 280)

        # Food Items List 1

        item_1 = Label(Constants.main_course, text = Constants.menu_1[0], font = "times 10 bold")
        item_1.place(x = 10, y = 100)

        price_1 = Label(Constants.main_course, text = Constants.menu_price_1[0], font = "times 10 bold")
        price_1.place(x = 180, y = 100)

        add_cart_1=Entry(Constants.main_course, font=("rockwell",13), textvariable=y_1)
        add_cart_1.place(x = 300,y = 100)

        item_2 = Label(Constants.main_course, text = Constants.menu_1[1], font = "times 10 bold")
        item_2.place(x = 10, y = 130)

        price_2 = Label(Constants.main_course, text = Constants.menu_price_1[1], font = "times 10 bold")
        price_2.place(x = 180, y = 130)

        add_cart_2=Entry(Constants.main_course, font=("rockwell",13), textvariable=y_2)
        add_cart_2.place(x = 300,y = 130)

        item_3 = Label(Constants.main_course, text = Constants.menu_1[2], font = "times 10 bold")
        item_3.place(x = 10, y = 160)

        price_3 = Label(Constants.main_course, text = Constants.menu_price_1[2], font = "times 10 bold")
        price_3.place(x = 180, y = 160)

        add_cart_3=Entry(Constants.main_course, font=("rockwell",13), textvariable=y_3)
        add_cart_3.place(x = 300,y = 160)

        item_4 = Label(Constants.main_course, text = Constants.menu_1[3], font = "times 10 bold")
        item_4.place(x = 10, y = 190)

        price_4 = Label(Constants.main_course, text = Constants.menu_price_1[3], font = "times 10 bold")
        price_4.place(x = 180, y = 190)

        add_cart_4=Entry(Constants.main_course, font=("rockwell",13), textvariable=y_4)
        add_cart_4.place(x = 300,y = 190)

        item_5 = Label(Constants.main_course, text = Constants.menu_1[4], font = "times 10 bold")
        item_5.place(x = 10, y = 220)

        price_5 = Label(Constants.main_course, text = Constants.menu_price_1[4], font = "times 10 bold")
        price_5.place(x = 180, y = 220)

        add_cart_5=Entry(Constants.main_course, font=("rockwell",13), textvariable=y_5)
        add_cart_5.place(x = 300,y = 220)

        Constants.main_course.mainloop()
    ...
    def paratha():
        ...
        backgroung_image = PhotoImage(file = r"assets\images\paratha.png")
        Label(Constants.paratha, image = backgroung_image).pack()
    ...
    def chinese():
        ...
        backgroung_image = PhotoImage(file = r"assets\images\chinese.png")
        Label(Constants.chinese, image = backgroung_image).pack()
